...
final class ImagegenCommand extends PromptWeaverCommand
{
    protected function configure(): void
    {
        ...
        $this->addOption('provider', null, InputOption::VALUE_REQUIRED, default: $this->aiConfig('image_provider'));
        $this->addOption('model', null, InputOption::VALUE_REQUIRED, default: $this->aiConfig('image_model'));
